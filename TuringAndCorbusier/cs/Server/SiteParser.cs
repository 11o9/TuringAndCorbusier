...
namespace TuringAndCorbusier
{
    class SiteParser
    {
        public static List<Pilji> ImprovedFind(Curve curve, List<Pilji> temppiljis)
        {
            ...
            var objects = temppiljis.Where(n => c.Contains(n.Outbound[0].Centroid()) != PointContainment.Inside).ToArray();
            ...
            start = DateTime.Now;
            Point3d[] closestpoints = new Point3d[objects.Length];
        ...
        public static double[] GetRoadWidths(Curve boundary)
        {

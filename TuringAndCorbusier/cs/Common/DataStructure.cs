    ...
    public class Consts
    {
        ...
        public static string connectionString
        {
            get
            {
                ...
                return "Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=db.i-sh.co.kr)(PORT=1522))(CONNECT_DATA=(SERVER=DEDICATED)(SID = smdcDB1)));User Id=autosd;Password=autosd;";
            }
        }

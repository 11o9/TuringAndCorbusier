...
namespace Reports
{
    ...
    public partial class xmlBuildingReport
    {
        public xmlBuildingReport(Apartment AGoutput)
        {
            ...
            this.plotArea_Manual.Text = String.Format("{0:0.00}",Math.Round(TuringAndCorbusierPlugIn.InstanceClass.page1Settings.PlotArea, 2)) + "m\xB2";
            //this.plotArea_Manual_Py.Text = Math.Round(TuringAndCorbusierPlugIn.InstanceClass.page1Settings.PlotArea / 3.3, 2).ToString() + "평";
            this.plotArea_Unusable.Text = String.Format("{0:0.00}", (0)).ToString() + "m\xB2";
            //this.plotArea_Unusable_Py.Text = (0 / 3.3).ToString() + "평";
            this.plotArea_Usable.Text = String.Format("{0:0.00}", Math.Round(AGoutput.Plot.GetArea() / 1000000, 2))+ "m\xB2";
            ...
            this.buildingScale.Text = buildingScaleForReport(AGoutput)+" / "+"철근 콘크리트";
            this.buildingArea.Text = String.Format("{0:0.00}", Math.Round(AGoutput.GetBuildingArea() / 1000000, 2)).ToString() + "m\xB2";
            //this.buildingArea_Py.Text = Math.Round(AGoutput.GetBuildingArea() / 1000000 / 3.3, 2).ToString() + "평";
            this.grossArea_UnderGround.Text = String.Format("{0:0.00}", Math.Round(AGoutput.ParkingLotUnderGround.ParkingArea / 1000000, 2)).ToString() + "m\xB2"; //////////////////////////////////////////////////////////////
            //this.grossArea_UnderGround_Py.Text = Math.Round(AGoutput.ParkingLotUnderGround.ParkingArea / 1000000 / 3.3, 2).ToString() + "평"; //////////////////////////////////////////////////////////////
            this.grossArea_OverGround.Text = String.Format("{0:0.00}", Math.Round(AGoutput.GetGrossArea() / 1000000, 2)- Math.Round(AGoutput.ParkingLotUnderGround.ParkingArea / 1000000, 2)).ToString() + "m\xB2";

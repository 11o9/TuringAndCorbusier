    ...
    public partial class xmlBuildingReport
    {
        ...
        public typicalPlan SetTypicalPlan
        {
            set
            {
                ...
                PlanDrawingFunction.drawPlan(tempBoundingBox, tempPlan.SurroundingSite, tempScaleFactor, tempOrigin, ref this.typicalPlan, System.Windows.Media.Brushes.Black, 0.2);
                PlanDrawingFunction.drawBackGround(tempBoundingBox, tempPlan.Boundary, tempScaleFactor, tempOrigin, ref this.typicalPlan, System.Windows.Media.Brushes.LightGray);
                PlanDrawingFunction.drawPlan(tempBoundingBox, tempPlan.Boundary, tempScaleFactor, tempOrigin, ref this.typicalPlan, System.Windows.Media.Brushes.Black, 0.5);

                foreach (Text3d i in tempPlan.RoadWidth)
                    PlanDrawingFunction.drawText(tempBoundingBox, i, tempScaleFactor, tempOrigin, ref this.typicalPlan, 10, System.Windows.Media.Brushes.HotPink);

                foreach (FloorPlan i in tempPlan.UnitPlans)
                {
                    PlanDrawingFunction.drawPlan(tempBoundingBox, i.doors, tempScaleFactor, tempOrigin, ref this.typicalPlan, System.Windows.Media.Brushes.Black, 0.2);
                    PlanDrawingFunction.drawPlan(tempBoundingBox, i.windows, tempScaleFactor, tempOrigin, ref this.typicalPlan, System.Windows.Media.Brushes.Black, 0.2);
                    PlanDrawingFunction.drawPlan(tempBoundingBox, i.tilings, tempScaleFactor, tempOrigin, ref this.typicalPlan, System.Windows.Media.Brushes.Black, 0.2);
                    PlanDrawingFunction.drawPlan(tempBoundingBox, i.walls, tempScaleFactor, tempOrigin, ref this.typicalPlan, System.Windows.Media.Brushes.Black, 0.2);
                }

                foreach (CorePlan i in tempPlan.CorePlans)
                {
                    PlanDrawingFunction.drawPlan(tempBoundingBox, i.normals, tempScaleFactor, tempOrigin, ref this.typicalPlan, System.Windows.Media.Brushes.Black, 0.2);
                    PlanDrawingFunction.drawPlan(tempBoundingBox, i.others, tempScaleFactor, tempOrigin, ref this.typicalPlan, System.Windows.Media.Brushes.DimGray, 0.2);
                    PlanDrawingFunction.drawPlan(tempBoundingBox, i.walls, tempScaleFactor, tempOrigin, ref this.typicalPlan, System.Windows.Media.Brushes.Black, 0.2);
                }

                PlanDrawingFunction.drawPlan(tempBoundingBox, tempPlan.OutLine.ToNurbsCurve(), tempScaleFactor, tempOrigin, ref this.typicalPlan, System.Windows.Media.Brushes.Black, 1);
